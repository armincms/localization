...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-language-toolbar', __webpack_require__(4));
    Vue.component('detail-language-toolbar', __webpack_require__(1));
    Vue.component('form-language-toolbar', __webpack_require__(1));
});
...
var update = __webpack_require__(9)("c9c9da74", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        Nova.$on('locale.changed', function (locale) {
            _this.activeLocale = locale;
        });
    },
...
var render = function() {
  ...
  return _vm.field.locales.length > 1
    ? _c(
        "field-wrapper",
        ...
        _vm._l(_vm.field.locales, function(locale) {
          return _c(
            ...
            {
              staticClass:
                "remove-last-margin-bottom leading-normal w-full py-4 px-8 text-center cursor-pointer",
              class:
                locale.name == _vm.activeLocale
                  ? "text-success font-bold bg-success-light"
                  : "text-primary bg-10",
              on: {
                click: function($event) {
                  $event.preventDefault()
                  return _vm.setActiveLocale(locale.name)
                }
              }
            },
